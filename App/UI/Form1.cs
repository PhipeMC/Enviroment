...
namespace App
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            /*
            if (a_points.Count == 3) {
                Angulo test = new Angulo(a_points[1], a_points[0], a_points[2]);
                parameters = fillData(test);
                label2.Text = parameters[0];
                Angulo test = new Angulo();
                double res = test.angulocal(a_points[1], a_points[0], a_points[2]);
                double resultado = test.calAngu(a_points[1], a_points[0], a_points[2]);
